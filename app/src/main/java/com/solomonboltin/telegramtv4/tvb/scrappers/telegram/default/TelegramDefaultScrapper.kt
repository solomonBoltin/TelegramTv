package com.solomonboltin.telegramtv4.tvb.scrappers.telegram.default

import androidx.compose.ui.graphics.ImageBitmap
import com.google.android.exoplayer2.MediaItem
import com.solomonboltin.telegramtv4.tvb.scrappers.interfaces.*
...
class TGScrappedMovieFiles(private val message: TdApi.Message?) : ScrapedMovieFiles {
    override fun getDefaultFile(): MediaItem? {
        ...
        return newMediaItem(TelegramVideoSource.UriFactory.create(1, file.video))
    }
