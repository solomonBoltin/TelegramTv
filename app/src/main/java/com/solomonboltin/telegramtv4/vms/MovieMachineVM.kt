...
//    }
//
//    fun movieDash(): MovieDash {
//        val actionMovies = movies.value.filter {
//            it.tags.contains("Action")
//        }
//
//        val comedyMovies = movies.value.filter {
//            it.tags.contains("Comedy")
//        }
//
//        return MovieDash(
//            movieLists = listOf(
//                MovieList("Action movies", actionMovies),
//                MovieList("Comedy movies", comedyMovies)
//            )
//        )
//    }
//
...
//                val movie = Movie(doc.fileName, "2000", doc.document, message, tags = listOf("Action"))
//                addMovie(movie)
//                return movie
//            }
//            is TdApi.MessageVideo -> {
//                val doc = (message.content as TdApi.MessageVideo).video
//                val movie = Movie(doc.fileName, "2000", doc.video, message, tags = listOf("Comedy"))
//                addMovie(movie)
//                return movie
//            }
//        }
